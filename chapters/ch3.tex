...
\begin{figure}[H]
	...
	\centering
	\subfloat[Lago di Endine]{\includegraphics[width=6cm]{image12}}
	\hspace{1cm}
	\subfloat[Edificio preesistente]{\includegraphics[width=6cm]{image24}}
	
	\caption{Immagini dall'alto}
	\label{fig:rimessaggio}
\end{figure}

\todo{scrivi qualcosa qua sulla planimetria}
\begin{figure}[H]
	\centering
